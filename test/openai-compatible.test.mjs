...
test("OpenAI-compatible maps nonstandard provider error bodies", async () => {
  const cases = [
    ...
    },
    {
      ...
      expectedMessage: "The model test-model does not exist",
      retryable: false,
    },
    {
      status: 400,
    ...
    {
      status: 400,
      body: { error: { message: "Rate limit exceeded for this model" } },
      expectedCode: "RATE_LIMITED",
      expectedMessage: "Rate limit exceeded for this model",
      retryable: true,
    },
    {
      status: 400,
      ...
      expectedCode: "CONTEXT_LENGTH_EXCEEDED",
      expectedMessage: "This model's maximum context length is 8192 tokens",
      retryable: false,
    },
    {
      status: 404,
